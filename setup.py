...
if __name__ == '__main__':
    setuptools.setup(
        name="vaik-text-generator",
        version="1.0.0",
        url="https://github.com/vaik-info/vaik-text-generator.git",
        install_requires=load_requires_from_file('requirements.txt'),
        dependency_links=load_links_from_file('requirements.txt'),
        author="vaik-info",
        author_email="info@vaikobo.com",
        description="Generate text image for training deep learning.",
        long_description="Generate text image for training deep learning.",
